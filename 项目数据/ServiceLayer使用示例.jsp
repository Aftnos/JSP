...
<head>
    <meta charset="UTF-8">
    <title>com.ServiceLayer 使用示例</title>
    <style>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;boolean loginSuccess = com.ServiceLayer.userLogin(username, password);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (loginSuccess) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;String result = com.ServiceLayer.userRegister(newUsername, newPassword);<br>
...
%&gt;
    ...
    <div class="example">
        ...
        <div class="code">
&lt;%<br>
&nbsp;&nbsp;&nbsp;&nbsp;List&lt;com.Model.Product&gt; products = com.ServiceLayer.getAllProducts();<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (products.isEmpty()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("暂无商品");<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (com.Model.Product product : products) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("商品名：" + product.name);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("价格：" + com.ServiceLayer.formatPrice(product.price));<br>
...
%&gt;
    ...
    <div class="example">
        ...
        <div class="code">
&lt;%<br>
&nbsp;&nbsp;&nbsp;&nbsp;int productId = com.ServiceLayer.safeParseInt(request.getParameter("id"), 0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (productId &gt; 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;com.Model.Product product = com.ServiceLayer.getProductById(productId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (product != null) {<br>
...
&lt;%<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 构建购物车<br>
&nbsp;&nbsp;&nbsp;&nbsp;List&lt;com.Model.CartItem&gt; cartItems = new ArrayList&lt;&gt;();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;com.Model.CartItem item1 = new com.Model.CartItem();<br>
&nbsp;&nbsp;&nbsp;&nbsp;item1.productId = 1;<br>
&nbsp;&nbsp;&nbsp;&nbsp;item1.quantity = 2;<br>
&nbsp;&nbsp;&nbsp;&nbsp;item1.price = 2999.0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;cartItems.add(item1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;com.Model.CartItem item2 = new com.Model.CartItem();<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;String result = com.ServiceLayer.createOrder(userId, cartItems);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if ("success".equals(result)) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;List&lt;com.Model.Order&gt; orders = com.ServiceLayer.getUserOrders(userId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (orders.isEmpty()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("您还没有订单");<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (com.Model.Order order : orders) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("订单号：" + order.id);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("下单时间：" + com.ServiceLayer.formatDateTime(order.orderDate));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("订单状态：" + order.status);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("订单总额：" + com.ServiceLayer.formatPrice(order.total));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
%&gt;
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 安全的浮点数转换<br>
&nbsp;&nbsp;&nbsp;&nbsp;double price = com.ServiceLayer.safeParseDouble(request.getParameter("price"), 0.0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (price &gt; 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// 处理有效的价格<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
%&gt;
...
&nbsp;&nbsp;&nbsp;&nbsp;String formattedPrice = com.ServiceLayer.formatPrice(price);<br>
&nbsp;&nbsp;&nbsp;&nbsp;out.println("价格：" + formattedPrice); // 输出：价格：¥2,999.50<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 格式化时间<br>
&nbsp;&nbsp;&nbsp;&nbsp;Timestamp now = new Timestamp(System.currentTimeMillis());<br>
&nbsp;&nbsp;&nbsp;&nbsp;String formattedTime = com.ServiceLayer.formatDateTime(now);<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// 3. 添加到购物车<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;List&lt;com.Model.CartItem&gt; cart = new ArrayList&lt;&gt;();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!products.isEmpty()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;com.Model.CartItem item = new com.Model.CartItem();<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// 4. 创建订单<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!cart.isEmpty()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;String orderResult = com.ServiceLayer.createOrder(1, cart);<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (com.ServiceLayer.isEmpty(productName)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out.println("&lt;span class='error'&gt;商品名称不能为空&lt;/span&gt;");<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;double price = com.ServiceLayer.safeParseDouble(request.getParameter("price"), 0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (price &lt;= 0) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// 调用业务方法<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;String result = com.ServiceLayer.addProduct(productName, price, 100, "测试商品");<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if ("success".equals(result)) {<br>
...
%&gt;
    ...
    <hr>
    <h2>总结</h2>
    <p>com.ServiceLayer 提供了以下主要功能：</p>
    <ul>
    ...
    <ul>
        <li>始终进行参数验证，使用 com.ServiceLayer 提供的安全转换方法</li>
        <li>统一使用 com.ServiceLayer 的返回格式进行错误处理</li>
